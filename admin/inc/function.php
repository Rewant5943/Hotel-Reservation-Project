<?php
    function add_lang(){
        ...
        if(isset($_POST['add_lang'])){
            ...
            if($count==1){
                echo"<script>alert('Language Already Addded')</script>";
                echo"<script>window.open('index.php?lang','_self')</script>";

            }else {
                $add_cat=$con->prepare("insert into lang(lang_name) values('$lang_name')");
                if($add_cat->execute()){
                    echo"<script>alert('Language Addded Successfully')</script>";
                    echo"<script>window.open('index.php?lang','_self')</script>";
                }else {
                    echo"<script>alert('Language Not Addded Successfully')</script>";
                    echo"<script>window.open('index.php?lang','_self')</script>";
                }
            }
    ...
    function add_cat(){
        ...
        if(isset($_POST['add_cat'])){
            ...
            if($count==1){
                echo"<script>alert('Category Already Addded')</script>";
                ...
                if($add_cat->execute()){
                    echo"<script>alert('Category Addded Successfully')</script>";
                    echo"<script>window.open('index.php?cat','_self')</script>";
                }else {
                    echo"<script>alert('Category Not Addded Successfully')</script>";
                    echo"<script>window.open('index.php?cat','_self')</script>";
                }
            }
    ...
    function add_sub_cat(){
        ...
        if(isset($_POST['add_sub_cat'])){
            ...
            if($count==1){
                ...
                echo"<script>alert('Sub Category Already Addded')</script>";
                ...
                if($add_cat->execute()){
                    echo"<script>alert('Sub Category Addded Successfully')</script>";
                    echo"<script>window.open('index.php?sub_cat','_self')</script>";
                }else {
                    echo"<script>alert('Sub Category Not Addded Successfully')</script>";
                    echo"<script>window.open('index.php?sub_cat','_self')</script>";
                }
            }
    ...
    function edit_sub_cat(){
        ...
        if(isset($_GET['edit_sub_cat'])){
            ...
            echo "<h3>Edit Sub Category</h3>
                <form id='edit_form' method='post' enctype='multipart/form-data'>
                <select name='c_id'>
                <option value='".$row_cat['cat_id']."'>".$row['cat_name']."</option>";
                    echo select_cat();
            echo "</select>
                <input type='text' name='sub_cat_name' value='".$row['sub_cat_name']."' placeholder='Enter Sub Category Name Here'>
    ...
    function add_term(){
        ...
        if(isset($_POST['add_term'])){
            ...
            if($count==1){
                ...
                echo"<script>alert('Term Is Already Addded')</script>";
                ...
                if($add_cat->execute()){
                    echo"<script>alert('Term Addded Successfully')</script>";
                    echo"<script>window.open('index.php?terms','_self')</script>";
                }else {
                    echo"<script>alert('Term Not Addded Successfully')</script>";
                    echo"<script>window.open('index.php?terms','_self')</script>";
                }
            }
    ...
    function view_term(){
        ...
        if(isset($_GET['del_term'])){
            ...
            if($del->execute()){
                ...
                echo"<script>alert('Terms Not Deleted Successfully')</script>";
                echo"<script>window.open('index.php?terms','_self')</script>";
            }
        }
    }
    ...
    function add_faqs(){
        ...
        if(isset($_POST['add_faqs'])){
            ...
            if($count==1){
                echo"<script>alert('FAQs Already Addded')</script>";
                echo"<script>window.open('index.php?faqs','_self')</script>";

            }else {
                $add_faqs=$con->prepare("insert into faqs(qsn,ans) values('$qsn','$ans')");
                if($add_faqs->execute()){
                    echo"<script>alert('FAQs Addded Successfully')</script>";
                    echo"<script>window.open('index.php?faqs','_self')</script>";
                }else {
                    echo"<script>alert('FAQs Not Addded Successfully')</script>";
                    echo"<script>window.open('index.php?faqs','_self')</script>";
                }
            }
        ...
        while($row=$get_faqs->fetch()):
            echo"<details>
                    ...
                    <form method='post' enctype='multipart/form-data'>
                        <input type='text' name='up_qsn' value='".$row['qsn']."' placeholder='Enter Questions Here'>
